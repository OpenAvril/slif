...
namespace CLIBOpenEpiCentre {
    ...
    public:
        ...
        bool dyn_REG_get_OpenEpiCentre_Execute_Control_ItemOnListOf_FLAGisThreadInitialised(uint8_t* sysThreadId);
        void dyn_REG_set_FLAG_CLIB_OpenEpiCentre_Execute_Control_isSystemInitialised(bool state);
        void dyn_REG_set_OpenEpiCentre_Execute_Control_ItemOnListOf_FLAGisThreadInitialised(uint8_t* sysThreadId, bool state);
    ...
    private:
        ...
        static void stat_set_ptr_CLIB_OpenEpiCentre_Execute_Control_ItemOnListOf_FLAGisThreadInitialised(uint8_t* sysThreadId, bool state);
    };
};
