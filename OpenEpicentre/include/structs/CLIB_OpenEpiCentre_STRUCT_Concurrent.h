...
namespace CLIBOpenEpiCentre
{
    ...
    public:
        ...
        uint8_t dyn_REG_get_CLIB_OpenEpiCentre_Concurrent_sysThreadId();
        void dyn_REG_set_CLIB_OpenEpiCentre_Concurrent_sysThreadId(uint8_t praiseId);
        static void stat_app_thread_Concurrency(CLIB_OpenEpiCentre_Framework* obj, uint8_t concurrentsysThreadId);
    ...
    private:
        static uint8_t* _stat_REG_CLIB_OpenEpiCentre_Concurrent_sysThreadId;
     };
}
#endif