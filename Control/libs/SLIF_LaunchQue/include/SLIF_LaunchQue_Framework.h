...
namespace slif {
    ...
    public:
        ...
        void dyn_CLASS_create_SLIF_LaunchQue_Framework_Global_and_Settings(uint8_t* threadId);
        ...
        static void stat_CLASS_boot3_INITIALISE_SLIF_LaunchQue_Framework(uint8_t* threadId);
    ...
    private:
        ...
        static void stat_CLASS_boot3_INITIALISE_SLIF_LaunchQue_Framework_App(uint8_t* threadId);
