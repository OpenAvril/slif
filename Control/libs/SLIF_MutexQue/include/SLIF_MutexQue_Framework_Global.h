...
namespace slif {
    ...
    public:
        ...
        std::byte dyn_REG_get_SLIF_MutexQue_number_Of_Implemented_Threads(uint8_t* sysThreadId);
        void dyn_REG_set_SLIF_MutexQue_number_Of_Implemented_Threads(uint8_t* sysThreadId, std::byte* MAX_NUMBER_OF_THREADS_FOR_ACCESS);
    ...
    private:
        ...
        static void stat_REG_boot3_REINITIALISE_ptr_SLIF_MutexQue_number_Of_Implemented_Threads(uint8_t* sysThreadId, std::byte* MAX_NUMBER_OF_THREADS_FOR_ACCESS);
