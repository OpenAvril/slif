...
#include <iostream>
    ...
    void slif::SLIF_MutexQue_Framework_App::dyn_APP_FUNCT_write_End(uint8_t* sysThreadId, slif::SLIF_MutexQue_Framework* obj, uint8_t coreId) {
        ...
        if (obj->dyn_CLASS_get_ptr_SLIF_MutexQue_App(sysThreadId)->dyn_CLASS_get_ptr_SLIF_MutexQue_App_Control(sysThreadId)->dyn_REG_get_FLAG_SLIF_MutexQue_Framework_App_Control_writeCycle_Try_WriteEndsysThreadId_Index(sysThreadId) == static_cast<uint8_t>(obj->dyn_CLASS_get_ptr_SLIF_MutexQue_Global(sysThreadId)->dyn_REG_get_SLIF_MutexQue_number_Of_Implemented_Threads(sysThreadId))) {
    ...
    void slif::SLIF_MutexQue_Framework_App::dyn_APP_FUNCT_write_Start(uint8_t* sysThreadId, slif::SLIF_MutexQue_Framework* obj, uint8_t coreId) {
        ...
        if (obj->dyn_CLASS_get_ptr_SLIF_MutexQue_App(sysThreadId)->dyn_CLASS_get_ptr_SLIF_MutexQue_App_Control(sysThreadId)->dyn_REG_get_FLAG_SLIF_MutexQue_Framework_App_Control_writeCycle_Try_WriteStartsysThreadId_Index(sysThreadId) == static_cast<uint8_t>(obj->dyn_CLASS_get_ptr_SLIF_MutexQue_Global(sysThreadId)->dyn_REG_get_SLIF_MutexQue_number_Of_Implemented_Threads(sysThreadId))) {
