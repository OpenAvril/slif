...
// private.
	void slif::MutexQue::slif_MutexQue_App_FUNCT_generate_Program(uint8_t* threadId) {
	...
	void slif::MutexQue::slif_MutexQue_stat_PGM_boot3_INITIALISE_array_of_ptr_Framework(uint8_t* threadId) {
		...
		slif_MutexQue_stat_PGM_get_array_of_ptr_SLIF_MutexQue(threadId)->assign(*handleId, static_cast<void*>(new class SLIF_MutexQue_Framework(threadId)));
		slif_MutexQue_App_FUNCT_generate_Program(threadId);
