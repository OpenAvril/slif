...
#include <iostream>
	slif::slif_MutexQueQue_Framework_App* slif::slif_MutexQueQue_Framework::_stat_CLASS_get_ptr_slif_MutexQue_Framework_App;
	slif::slif_MutexQue_Framework_Global* slif::slif_MutexQueQue_Framework::_stat_CLASS_ptr_slif_MutexQue_Framework_Global;
// public.
	slif::slif_MutexQueQue_Framework::slif_MutexQueQue_Framework(uint8_t threadId) {
	...
	slif::slif_MutexQueQue_Framework::~slif_MutexQueQue_Framework() {
	...
	void slif::slif_MutexQueQue_Framework::dyn_CLASS_create_slif_MutexQue_Architecture(uint8_t threadId) {
	...
	void slif::slif_MutexQueQue_Framework::dyn_CLASS_create_slif_MutexQue_Global_and_Settings(uint8_t threadId)
	{
	...
	slif::slif_MutexQueQue_Framework_App* slif::slif_MutexQueQue_Framework::dyn_CLASS_get_ptr_slif_MutexQue_App(uint8_t threadId) {
	...
	slif::slif_MutexQue_Framework_Global* slif::slif_MutexQueQue_Framework::dyn_CLASS_get_ptr_slif_MutexQue_Global(uint8_t threadId) {
	...
	void slif::slif_MutexQueQue_Framework::stat_CLASS_boot1_DEFINE_slif_MutexQue_Framework(uint8_t threadId) {
	...
	void slif::slif_MutexQueQue_Framework::stat_CLASS_boot3_INITIALISE_slif_MutexQue_Framework(uint8_t threadId) {
	...
	void slif::slif_MutexQueQue_Framework::stat_CLASS_boot3_INITIALISE_slif_MutexQue_Global(uint8_t threadId) {
...
// private.
	void slif::slif_MutexQueQue_Framework::stat_CLASS_boot1_DEFINE_slif_MutexQue_App(uint8_t threadId) {
	...
	void slif::slif_MutexQueQue_Framework::stat_CLASS_boot1_DEFINE_slif_MutexQue_Global(uint8_t threadId) {
	...
	void slif::slif_MutexQueQue_Framework::stat_CLASS_boot3_INITIALISE_slif_MutexQue_App(uint8_t threadId)	{
		...
		_stat_CLASS_get_ptr_slif_MutexQue_Framework_App = new class slif::slif_MutexQueQue_Framework_App(threadId);
		while (stat_CLASS_get_ptr_slif_MutexQue_App(threadId) == nullptr) {}
		std::cout << "thread " << std::to_string(threadId) << " :: entered LIB :: slif : slif_MutexQue_Framework : stat_CLASS_boot3_INITIALISE_slif_MutexQue_App(threadId)." << std::endl;
	}
	void slif::slif_MutexQueQue_Framework::pr_stat_CLASS_boot3_INITIALISE_slif_MutexQue_Global(uint8_t threadId) {
	...
	slif::slif_MutexQueQue_Framework_App* slif::slif_MutexQueQue_Framework::stat_CLASS_get_ptr_slif_MutexQue_App(uint8_t threadId) {
	...
	slif::slif_MutexQue_Framework_Global* slif::slif_MutexQueQue_Framework::stat_CLASS_get_ptr_slif_MutexQue_Global(uint8_t threadId) {
