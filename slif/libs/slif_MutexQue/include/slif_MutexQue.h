...
extern "C" {
    namespace slif {
        class MutexQue {
        public:
            static void* generateProgram(uint8_t threadId, std::byte* MAX_NUMBER_OF_THREADS_FOR_ACCESS);
            static unsigned char* slif_MutexQue_App_FUNCT_get_FLAG_isPGM_INSTANTIATED(uint8_t threadId, uint8_t dataClusterId);
            static void slif_MutexQue_App_FUNCT_terminate_Program(uint8_t threadId, uint8_t dataClusterId);
        ...
        private:
            ...
            static void slif_MutexQue_stat_PGM_boot2_SUBSTANTIATE_array_of_ptr_Framework(uint8_t threadId);
            static void slif_MutexQue_stat_PGM_boot3_INITIALISE_array_of_ptr_Framework(uint8_t threadId, std::byte MAX_NUMBER_OF_DATA_CLUSTERS);
            ...
            static class slif_MutexQueQue_Framework* slif_MutexQue_stat_PGM_get_ptr_slif_MutexQue(uint8_t threadId, uint8_t dataClusterId);
        };
    }
}
#endif
