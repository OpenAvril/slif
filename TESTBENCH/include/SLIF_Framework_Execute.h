...
namespace slif {
    ...
    public:
        SLIF_Framework_Execute(uint8_t* sysThreadId);
    ...
    private:
        ...
        static void stat_PGM_boot1_DEFINE_HandleId_For_PGM_slifMutexQue(uint8_t* sysThreadId);
        static void stat_PGM_boot1_DEFINE_HandleId_For_PGM_slifLaunchQue(uint8_t* sysThreadId);
        static void stat_PGM_boot2_SUBSTANTIATE_HandleId_For_PGM_slifMutexQue(uint8_t* sysThreadId);
        static void stat_PGM_boot2_SUBSTANTIATE_HandleId_For_PGM_slifLaunchQue(uint8_t* sysThreadId);
        static void stat_PGM_boot3_INITIALISE_HandleId_For_PGM_slifMutexQue(uint8_t* sysThreadId);
        static void stat_PGM_boot3_INITIALISE_HandleId_For_PGM_slifLaunchQue(uint8_t* sysThreadId);
        static int* stat_PGM_get_array_of_ptrPGM_HandleId_For_PGM_slifMutexQue(uint8_t* sysThreadId);
        static int* stat_PGM_get_array_of_ptrPGM_HandleId_For_PGM_slifLaunchQue(uint8_t* sysThreadId);
    };
};
