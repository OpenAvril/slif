...
extern "C" {
    namespace slif {
        class Native {
        public:
            static void* generateProgram(uint8_t threadId, std::byte* MAX_NUMBER_OF_THREADS_FOR_TASKS);
            static void slif_LaunchQue_Framework_App_FUNCT_terminate_Progaram(uint8_t threadId);
        private:
        ...
        class LaunchQue {
        public:
            static void slif_LaunchQue_Framework_App_FUNCT_request_Wait_launch(uint8_t threadId, unsigned char* bytes);
            static void slif_LaunchQue_Framework_App_FUNCT_thread_End(uint8_t threadId, unsigned char* bytes);
