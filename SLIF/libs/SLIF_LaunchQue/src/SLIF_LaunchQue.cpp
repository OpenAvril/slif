...
// Native.
    // public.
    void* slif::Native::generateProgramLaunchQue(uint8_t threadId, std::byte* MAX_NUMBER_OF_THREADS_FOR_ACCESS) {
    ...
    void slif::Native::terminate_ProgaramLaunchQue(uint8_t threadId)
    {
