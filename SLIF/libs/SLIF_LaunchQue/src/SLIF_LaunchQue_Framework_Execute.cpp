...
// private.
    ...
    void slif::SLIF_LaunchQue_Framework_Execute::stat_REG_boot3_INITIALISE_HandleId_For_PGM_slifMutexQue(uint8_t* threadId) {
        ...
        *MAX_NUMBER_OF_THREADS_FOR_ACCESS = static_cast<std::byte>(3);
        *stat_REG_HandleId_For_PGM_slifMutexQue = *slif::MutexQue::generateHandle(*threadId, MAX_NUMBER_OF_THREADS_FOR_ACCESS);
    }
